...
fileprivate enum WMKeychainWrapperName: String {
    case main = "ru.roxchat.RoxchatClientSDKiOS.faq"
}
...
final class FAQImpl {
    ...
    private static func deleteDBFileFor() {
        ...
        guard let documentsDirectory = optionalDocumentsDirectory else {
            RoxchatInternalLogger.shared.log(entry: "Error getting access to Documents directory.",
        ...
        do {
            ...
            RoxchatInternalLogger.shared.log(entry: "Error deleting DB file at \(dbURL) or file doesn't exist.",
                                           verbosityLevel: .verbose)
        }
    }
